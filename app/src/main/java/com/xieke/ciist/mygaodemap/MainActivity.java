...
public class MainActivity extends ListActivity {
    ...
    protected List<Map<String, Object>> getData() { // 封装添加资源方法
        ...
        addItem(data, "显示地图", ShowMapActivity.class); // 调用方法，添加第一个元素
        addItem(data, "基本导航页", BasicNaviActivity.class); // 调用方法，添加第一个元素
        addItem(data, "启动地图实时导航驾车模式", GPSNaviActivity.class); // 调用方法，添加第一个元素
        addItem(data, "启动地图实时导航步行模式", BasicWalkNaviActivity.class); // 调用方法，添加第一个元素
